...
out1$Slope <- format(round(out1$Slope,
                           3), 
                     digits = 3)
out1$`95% C.I.L.B.` <- format(round(out1$`95% C.I.L.B.`,
                                    3), 
                              digits = 3)
out1$`95% C.I.U.B.` <- format(round(out1$`95% C.I.U.B.`,
                                    3), 
                              digits = 3)
...
datatable(out1)
```
Risk of death within 3 years from initial HF discharge was significantly higher in patients who were readmitted for any cause within 1 year from the said discharge (OR = 1.63, 95% C.I. = 1.59 to 1.68, p-value < 0.001).
