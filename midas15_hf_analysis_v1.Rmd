...
```{r plotHF, fig.height=5, fig.width=7}
# Plot HF discharges----
p0 <- ggplot(t1,
             aes(x = Year,
                 y = Counts)) +
...
DT::datatable(table1,
              caption = "HF Patients' Demographics",
              rownames = TRUE,
              options = list(searching = TRUE,
...
# Part II: Rates
```{r Rates, fig.height=7, fig.width=8}
invisible({
...
# Length of stay
case$los <- difftime(case$DSCHDAT,
                     case$ADMDAT,
                     units = "days")
```

## All-Cause Readmissions
```{r glmAllReadm, fig.height=5, fig.width=10}
...
```{r glmHFReadm, fig.height=5, fig.width=10}
# Publication/Table 2a: All-cause readmissions----
...
## All-Cause Death
```{r glmAllCauseDeath, fig.height=5, fig.width=10}
...
## CV Death
```{r glmCVdeath, fig.height=5, fig.width=10}
